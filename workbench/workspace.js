...
const statusName={pass:'通过',fail:'存在差额',missing:'缺少输入',comparable:'可比',qualified:'有条件参考',blocked:'不可直接比较'};
const pageHelp={
