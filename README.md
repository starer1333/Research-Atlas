...
推荐以网页产品为主，同时提供同代码的离线版。GitHub 保存代码与证据记录；公开展示站仅包含脱敏演示内容。用户已指定公开仓库 https://github.com/starer1333/Research-Atlas ，模拟演示网页已公开发布。真实资料接入、模型调用、持久化、完整估值和跨公司可比性审核尚未实现。
